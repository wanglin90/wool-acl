...
INSERT INTO `wool_acl_resource` VALUES ('5', '1', '1', '11', '查看APP列表', 'app:list', '查看APP列表');
...
INSERT INTO `wool_acl_resource` VALUES ('9', '1', '2', '21', '查询角色列表', 'role:list', '查询角色列表');
...
INSERT INTO `wool_acl_resource` VALUES ('13', '1', '2', '25', '配置角色权限', 'role:configResource', '配置角色权限');
INSERT INTO `wool_acl_resource` VALUES ('14', '1', '3', '31', '查看资源列表', 'res:list', '查看资源列表');
...
INSERT INTO `wool_acl_resource` VALUES ('18', '1', '4', '41', '查看用户列表', 'user:list', '查看用户列表');
